        ...
        <div className="container5">
          ...
          <div className="timeline">
            ...
            <div className="timeline-item">
              ...
              <div className="timeline-content">
                <h4>First Magazine Release - Antarang</h4>
                <p>The inaugural <Link to="/magazine" className="timeline-link">magazine</Link> of Swarajya-MLA was officially unveiled by Chief Guest Ajinkya Raut during Aarambh 2026. The release marked a proud milestone, showcasing the club's journey, Marathi culture, literary creativity, and the talents of its members.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          {activeDropdown === '2025-26' && (
            <div className="committee-wrapper slide-down">
              ...
              <div className="executive-board-section">
                  ...
                  <div className="members-grid single-member">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={akhilesh} alt="Akhilesh Deshmukh" className="member-image" />
                      </div>
                ...
                <div className="vice-presidents-section">
                  ...
                  <div className="members-grid two-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={vedant} alt="Vedant Deshpande" className="member-image" />
                      </div>
                      <h5 className="member-name">Vedant Deshpande</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={rajat} alt="Rajat Murhe" className="member-image" />
                      </div>
                ...
                <div className="general-secretaries-section">
                  ...
                  <div className="members-grid single-member">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={shivam} alt="Shivam Chavan" className="member-image" />
                      </div>
              ...
              <div className="department-leads-section">
                <h3 className="section-title">
                  <span className="section-icon"><img src={departmentIcon} alt="Department Leads" className="section-title-icon" /></span> Department Leads
                </h3>
                ...
                <div className="department-section">
                  ...
                  <div className="members-grid single-member">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={sakhi} alt="Sakhi Telang" className="member-image" />
                      </div>
                ...
                <div className="department-section">
                  ...
                  <div className="members-grid two-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={anay} alt="Anay Patil" className="member-image" />
                      </div>
                      <h5 className="member-name">Anay Patil</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={anish} alt="Anish Sadvilkar" className="member-image" />
                      </div>
                ...
                <div className="department-section">
                  <h4 className="department-title">
                    <span className="department-icon"><img src={technicalIcon} alt="Technical" className="dept-emoticon-about" /></span> Technical
                  </h4>
                  <div className="members-grid two-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={omkar} alt="Omkar Pawar" className="member-image" />
                      </div>
                      <h5 className="member-name">Omkar Pawar</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={ritesh} alt="Ritesh Chaudhari" className="member-image" />
                      </div>
                ...
                <div className="department-section">
                  <h4 className="department-title">
                    <span className="department-icon"><img src={culturalIcon} alt="Cultural" className="dept-emoticon-about" /></span> Cultural
                  </h4>
                  <div className="members-grid three-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={janhavi} alt="Janhavi Dessai" className="member-image" />
                      </div>
                      <h5 className="member-name">Janhavi Dessai</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={varun} alt="Varun V" className="member-image" />
                      </div>
                      <h5 className="member-name">Varun V</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={sai} alt="Sai Tandel" className="member-image" />
                      </div>
                ...
                <div className="department-section">
                  <h4 className="department-title">
                    <span className="department-icon"><img src={operationsIcon} alt="Operations" className="dept-emoticon-about" /></span> Operations
                  </h4>
                  <div className="members-grid three-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={vinayak} alt="Vinayak Rathod" className="member-image" />
                      </div>
                      <h5 className="member-name">Vinayak Rathod</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={shreya} alt="Shreya Mahajan" className="member-image" />
                      </div>
                      <h5 className="member-name">Shreya Mahajan</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={sarang} alt="Sarang Ingavle" className="member-image" />
                      </div>
                ...
                <div className="department-section">
                  ...
                  <div className="members-grid two-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={swaraj} alt="Swaraj Tekale" className="member-image" />
                      </div>
                      <h5 className="member-name">Swaraj Tekale</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={nikhil} alt="Nikhil Parkar" className="member-image" />
                      </div>
              ...
              <div className="department-leads-section">
                ...
                <div className="department-section">
                  ...
                  <div className="members-grid two-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={om_j_26} alt="Om Jadhav" className="member-image" />
                      </div>
                      <h5 className="member-name">Om Jadhav</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={riddhi_26} alt="Riddhi Marathe" className="member-image" />
                      </div>
                ...
                <div className="department-section">
                  ...
                  <div className="members-grid two-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={mrun_26} alt="Mrunmayee Kulat" className="member-image" />
                      </div>
                      <h5 className="member-name">Mrunmayee Kulat</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={naman_26} alt="Naman Ghodake" className="member-image" />
                      </div>
                ...
                <div className="department-section">
                  ...
                  <div className="members-grid three-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={ankana_26} alt="Ankana Datta" className="member-image" />
                      </div>
                      <h5 className="member-name">Ankana Datta</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={pranav_26} alt="Pranav Bhujbal" className="member-image" />
                      </div>
                      <h5 className="member-name">Pranav Bhujbal</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={pranjal_26} alt="Pranjal Dadsena" className="member-image" />
                      </div>
                ...
                <div className="department-section">
                  ...
                  <div className="members-grid three-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={omkar_26} alt="Omkar Jagtap" className="member-image" />
                      </div>
                      <h5 className="member-name">Omkar Jagtap</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={atharva_26} alt="Atharva Chougule" className="member-image" />
                      </div>
                      <h5 className="member-name">Atharva Chougule</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={shravani_26} alt="Shravani Choudhari" className="member-image" />
                      </div>
                ...
                <div className="department-section">
                  <h4 className="department-title">
                    <span className="department-icon"><img src={financeIcon} alt="Finance" className="dept-emoticon-about" /></span> Finance And Outreach
                  </h4>
                  <div className="members-grid two-members">
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={atharva_d_26} alt="Atharva Deshpande" className="member-image" />
                      </div>
                      <h5 className="member-name">Atharva Deshpande</h5>
                    </div>
                    <div className="member-card">
                      <div className="member-image-container">
                        <img loading="lazy" src={shunyam_26} alt="Shunyamprakash Firke" className="member-image" />
                      </div>
